...
CREATE TABLE IF NOT EXISTS Hospital
  ...
  Address INTEGER REFERENCES Place(ID) ON DELETE CASCADE  NOT NULL ,
...
CREATE TABLE IF NOT EXISTS Doctor
  ...
  Hospital INTEGER REFERENCES Hospital(ID) ON DELETE CASCADE  NOT NULL,
  Rate INTEGER DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS History -- Sickness history
  ...
  Doctor CHAR(11) REFERENCES  Doctor(HumanTC)  ON DELETE CASCADE ,
  Patient CHAR(11) REFERENCES Human(TC)  ON DELETE CASCADE ,
