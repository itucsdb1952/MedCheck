...
.. note:: This part is done by Furkan

.. note:: def add_hospital(name: str = None, city: str = None, district: str = None, park: bool = False,
...
.. note:: This part is done by Emre
...
.. note:: def add_doctor(human_id, workdays, expertise, hospital_id):
    try:
        with dbapi2.connect(db_url) as connection:
            with connection.cursor() as cursor:
